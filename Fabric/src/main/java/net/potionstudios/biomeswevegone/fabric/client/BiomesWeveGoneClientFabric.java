...
public class BiomesWeveGoneClientFabric implements ClientModInitializer {
    ...
    private void renderTypeBlock(Block block) {
        if (block instanceof BWGFruitBlock || block instanceof CampfireBlock || block instanceof DoorBlock || block instanceof TrapDoorBlock)
            BlockRenderLayerMap.INSTANCE.putBlock(block, RenderType.cutout());
        else if (block instanceof BushBlock || block instanceof LeavesBlock || block instanceof VineBlock || block instanceof LanternBlock
