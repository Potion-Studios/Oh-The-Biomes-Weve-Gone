...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        BWGWoodSet.woodsets().forEach(set -> {
            ...
            ShapelessRecipeBuilder.shapeless(itemRegistry, RecipeCategory.TRANSPORTATION, set.chestBoatItem().get()).requires(Tags.Items.CHESTS_WOODEN).requires(set.boatItem().get()).group("chest_boat").unlockedBy("has_boat", has(ItemTags.BOATS)).save(output);
        });
        ...
        nineBlockStorageRecipes(RecipeCategory.DECORATIONS, BWGBlocks.PINK_ALLIUM.getItem(), RecipeCategory.DECORATIONS, BWGBlocks.PINK_ALLIUM_PETAL_BLOCK.get());
        nineBlockStorageRecipes(RecipeCategory.DECORATIONS, BWGBlocks.WHITE_ALLIUM.getItem(), RecipeCategory.DECORATIONS, BWGBlocks.WHITE_ALLIUM_PETAL_BLOCK.get());
        nineBlockStorageRecipes(RecipeCategory.DECORATIONS, BWGBlocks.ROSE.getItem(), RecipeCategory.DECORATIONS, BWGBlocks.ROSE_PETAL_BLOCK.get());
