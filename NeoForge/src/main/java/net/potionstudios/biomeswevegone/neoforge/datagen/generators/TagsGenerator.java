...
public class TagsGenerator {
    ...
    public static void init(DataGenerator generator, boolean run, PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
        ...
        generator.addProvider(run, new EnchantmentTagGenerator(output, lookupProvider));
    }
    ...
    private static class BlockTagGenerator extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.@NotNull Provider provider) {
            ...
            tag(BWGBlockTags.DAFFODILS).add(BWGBlocks.DAFFODIL.get(), BWGBlocks.PINK_DAFFODIL.get(), BWGBlocks.YELLOW_DAFFODIL.get());
            tag(BlockTags.SMALL_FLOWERS).addTag(BWGBlockTags.SHORT_ALLIUMS).addTag(BWGBlockTags.ROSES).addTag(BWGBlockTags.TULIPS).addTag(BWGBlockTags.AMARANTH).addTag(BWGBlockTags.SAGES).addTag(BWGBlockTags.DAFFODILS)
                    .add(BWGBlocks.PINK_ANEMONE.get(), BWGBlocks.WHITE_ANEMONE.get(), BWGBlocks.ALPINE_BELLFLOWER.get(), BWGBlocks.LAZARUS_BELLFLOWER.get(), BWGBlocks.PEACH_LEATHER_FLOWER.get(),
                            BWGBlocks.VIOLET_LEATHER_FLOWER.get(), BWGBlocks.ANGELICA.get(), BWGBlocks.BEGONIA.get(), BWGBlocks.BISTORT.get(), BWGBlocks.CALIFORNIA_POPPY.get(), BWGBlocks.CROCUS.get(),
                            BWGBlocks.FAIRY_SLIPPER.get(), BWGBlocks.GUZMANIA.get(), BWGBlocks.INCAN_LILY.get(), BWGBlocks.IRIS.get(), BWGBlocks.KOVAN_FLOWER.get(), BWGBlocks.LOLLIPOP_FLOWER.get(),
                            BWGBlocks.ORANGE_DAISY.get(), BWGBlocks.PROTEA_FLOWER.get(), BWGBlocks.PROTEA_FLOWER.get(), BWGBlocks.SILVER_VASE_FLOWER.get(), BWGBlocks.RICHEA.get(), BWGBlocks.SNOWDROPS.get(),
                            BWGBlocks.WINTER_CYCLAMEN.get(), BWGBlocks.WINTER_SCILLA.get());
            ...
            tag(BlockTags.BEE_ATTRACTIVE).addTag(BWGBlockTags.SHORT_ALLIUMS).addTag(BWGBlockTags.ROSES).addTag(BWGBlockTags.TULIPS).addTag(BWGBlockTags.AMARANTH).addTag(BWGBlockTags.SAGES).addTag(BWGBlockTags.DAFFODILS)
                    .add(BWGBlocks.PINK_ANEMONE.get(), BWGBlocks.WHITE_ANEMONE.get(), BWGBlocks.ALPINE_BELLFLOWER.get(), BWGBlocks.LAZARUS_BELLFLOWER.get(), BWGBlocks.PEACH_LEATHER_FLOWER.get(),
                            BWGBlocks.VIOLET_LEATHER_FLOWER.get(), BWGBlocks.ANGELICA.get(), BWGBlocks.BEGONIA.get(), BWGBlocks.BISTORT.get(), BWGBlocks.CALIFORNIA_POPPY.get(), BWGBlocks.CROCUS.get(),
                            BWGBlocks.FAIRY_SLIPPER.get(), BWGBlocks.GUZMANIA.get(), BWGBlocks.INCAN_LILY.get(), BWGBlocks.IRIS.get(), BWGBlocks.KOVAN_FLOWER.get(), BWGBlocks.LOLLIPOP_FLOWER.get(),
                            BWGBlocks.ORANGE_DAISY.get(), BWGBlocks.PROTEA_FLOWER.get(), BWGBlocks.PROTEA_FLOWER.get(), BWGBlocks.SILVER_VASE_FLOWER.get(), BWGBlocks.RICHEA.get(), BWGBlocks.SNOWDROPS.get(),
                            BWGBlocks.WINTER_CYCLAMEN.get(), BWGBlocks.WINTER_SCILLA.get(), BWGBlocks.FLOWER_PATCH.get(), BWGBlocks.WHITE_SAKURA_PETALS.get(), BWGBlocks.YELLOW_SAKURA_PETALS.get(), BWGBlocks.FLOWERING_BARREL_CACTUS.get(), BWGBlocks.FLOWERING_TINY_LILY_PADS.get(),
                            BWGBlocks.FLOWERING_JACARANDA_BUSH.get(), BWGBlocks.FLOWERING_INDIGO_JACARANDA_BUSH.get(), BWGWood.FLOWERING_PALO_VERDE_LEAVES.get(), BWGWood.FLOWERING_SKYRIS_LEAVES.get(), BWGWood.FLOWERING_IRONWOOD_LEAVES.get(),
                            BWGWood.FLOWERING_INDIGO_JACARANDA_LEAVES.get(), BWGWood.FLOWERING_JACARANDA_LEAVES.get(), BWGWood.FLOWERING_YUCCA_LEAVES.get(), BWGWood.FLOWERING_ORCHARD_LEAVES.get(), BWGWood.FLOWERING_BAOBAB_LEAVES.get());
            ...
            tag(BlockTags.CANNOT_SUPPORT_SNOW_LAYER).addTag(BWGBlockTags.BLACK_ICE).addTag(BWGBlockTags.BOREALIS_ICE);
            ...
            tag(BlockTags.REPLACEABLE_BY_MUSHROOMS).add(BWGBlocks.PODZOL_DACITE.get(), BWGBlocks.WHITE_PODZOL_DACITE.get());
            tag(BWGBlockTags.SNOWY_PLANT_PLACEABLE).add(Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW).addTag(BlockTags.DIRT);
            tag(BWGBlockTags.BWG_MUSHROOM_PLACEABLE).addTag(BlockTags.REPLACEABLE_BY_MUSHROOMS).addTag(BlockTags.BASE_STONE_OVERWORLD).addTag(BlockTags.DIRT);
            ...
            tag(BWGBlockTags.OAK_SAPLINGS).add(BWGWood.BROWN_OAK_SAPLING.get(), BWGWood.ORANGE_OAK_SAPLING.get(), BWGWood.RED_OAK_SAPLING.get());
            tag(BWGBlockTags.SPRUCE_SAPLINGS).add(BWGWood.BLUE_SPRUCE_SAPLING.get(), BWGWood.RED_SPRUCE_SAPLING.get(), BWGWood.YELLOW_SPRUCE_SAPLING.get(), BWGWood.ORANGE_SPRUCE_SAPLING.get());
            tag(BWGBlockTags.BIRCH_SAPLINGS).add(BWGWood.YELLOW_BIRCH_SAPLING.get(), BWGWood.ORANGE_BIRCH_SAPLING.get(), BWGWood.RED_BIRCH_SAPLING.get(), BWGWood.BROWN_BIRCH_SAPLING.get());
            ...
            tag(ModTags.Blocks.SPRING_CROPS).add(BWGBlocks.ODDION_CROP.get(), BWGBlocks.BLUEBERRY_BUSH.get(), BWGWood.YELLOW_SAKURA_SAPLING.get(), BWGWood.WHITE_SAKURA_SAPLING.get(), BWGWood.CYPRESS.sapling().get(), BWGWood.FIR.sapling().get(), BWGWood.EBONY.sapling().get(), BWGWood.HOLLY.sapling().get(),
                            BWGWood.JACARANDA.sapling().get(), BWGWood.INDIGO_JACARANDA_SAPLING.get(), BWGWood.MAHOGANY.sapling().get(), BWGWood.MAPLE.sapling().get(), BWGWood.SILVER_MAPLE_SAPLING.get(), BWGWood.PALM.sapling().get(), BWGWood.PINE.sapling().get(), BWGWood.REDWOOD.sapling().get(), BWGWood.WHITE_MANGROVE.sapling().get(), BWGWood.WILLOW.sapling().get(),
                            BWGWood.WITCH_HAZEL.sapling().get(), BWGWood.ZELKOVA.sapling().get(), BWGWood.BROWN_ZELKOVA_SAPLING.get(), BWGWood.IRONWOOD.sapling().get(), BWGWood.RAINBOW_EUCALYPTUS.sapling().get(), BWGWood.ARAUCARIA_SAPLING.get(), BWGWood.ORCHARD_SAPLING.get(), BWGWood.YUCCA_SAPLING.get(), BWGWood.SPIRIT.sapling().get())
                    .addTag(BWGBlockTags.GLOWCANE).addTag(BWGBlockTags.SPRUCE_SAPLINGS).addTag(BWGBlockTags.BIRCH_SAPLINGS);
            tag(ModTags.Blocks.SUMMER_CROPS).add(BWGBlocks.ODDION_CROP.get(), BWGBlocks.BLUEBERRY_BUSH.get(), BWGWood.BAOBAB.sapling().get(), BWGWood.JACARANDA.sapling().get(), BWGWood.INDIGO_JACARANDA_SAPLING.get(), BWGWood.MAHOGANY.sapling().get(), BWGWood.PALM.sapling().get(), BWGWood.REDWOOD.sapling().get(), BWGWood.WHITE_MANGROVE.sapling().get(),
                            BWGWood.PALO_VERDE_SAPLING.get(), BWGWood.RAINBOW_EUCALYPTUS.sapling().get(), BWGWood.GREEN_ENCHANTED.sapling().get(), BWGWood.BLUE_ENCHANTED.sapling().get(), BWGWood.ARAUCARIA_SAPLING.get(), BWGWood.ORCHARD_SAPLING.get(), BWGWood.YUCCA_SAPLING.get(), BWGWood.SPIRIT.sapling().get())
                    .addTag(BWGBlockTags.GLOWCANE);
            tag(ModTags.Blocks.WINTER_CROPS).add(BWGWood.SKYRIS.sapling().get()).addTag(BWGBlockTags.SPRUCE_SAPLINGS);
    ...
    private static class ItemTagGenerator extends BlockTagCopyingItemTagProvider {
        ...
        protected void addTags(HolderLookup.@NotNull Provider provider) {
            ...
            tag(Tags.Items.MUSIC_DISCS).add(BWGItems.MUSIC_DISC_PIXIE_CLUB.get(), BWGItems.MUSIC_DISC_BETTER_DAYS.get());
            ...
            //Pumpkin Warden
            tag(BWGItemTags.PUMPKIN_WARDEN_PICKS_UP).add(Items.PUMPKIN_PIE).addOptionalTag(Tags.Items.EGGS).addOptionalTag(Tags.Items.PUMPKINS).addOptionalTag(TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("forge", "eggs")));

            //Serene Seasons
            tag(ModTags.Items.YEAR_ROUND_CROPS).add(BWGBlocks.GREEN_MUSHROOM.get().asItem(), BWGBlocks.WEEPING_MILKCAP.get().asItem(), BWGBlocks.WOOD_BLEWIT.get().asItem(), BWGWood.ASPEN.sapling().getItem(), BWGWood.RED_MAPLE_SAPLING.getItem()).addTag(BWGItemTags.OAK_SAPLINGS);
            tag(ModTags.Items.AUTUMN_CROPS).add(BWGItems.PALE_PUMPKIN_SEEDS.get(), BWGWood.CYPRESS.sapling().getItem(), BWGWood.EBONY.sapling().getItem(), BWGWood.FIR.sapling().getItem(), BWGWood.HOLLY.sapling().getItem(), BWGWood.JACARANDA.sapling().getItem(), BWGWood.INDIGO_JACARANDA_SAPLING.getItem(), BWGWood.MAPLE.sapling().getItem(), BWGWood.SILVER_MAPLE_SAPLING.getItem(), BWGWood.PINE.sapling().getItem(),
                    BWGWood.WILLOW.sapling().getItem(), BWGWood.WITCH_HAZEL.sapling().getItem(), BWGWood.ZELKOVA.sapling().getItem(), BWGWood.BROWN_ZELKOVA_SAPLING.getItem(), BWGWood.IRONWOOD.sapling().getItem(), BWGWood.SKYRIS.sapling().getItem(), BWGWood.CIKA.sapling().getItem(), BWGWood.ORCHARD_SAPLING.getItem(), BWGWood.YUCCA_SAPLING.getItem()).addTag(BWGItemTags.BIRCH_SAPLINGS).addTag(BWGItemTags.SPRUCE_SAPLINGS);
            tag(ModTags.Items.SPRING_CROPS).add(BWGItems.ODDION_BULB.get(), BWGWood.YELLOW_SAKURA_SAPLING.getItem(), BWGWood.WHITE_SAKURA_SAPLING.getItem(), BWGWood.CYPRESS.sapling().getItem(), BWGWood.FIR.sapling().getItem(), BWGWood.EBONY.sapling().getItem(), BWGWood.HOLLY.sapling().getItem(),
                    BWGWood.JACARANDA.sapling().getItem(), BWGWood.INDIGO_JACARANDA_SAPLING.getItem(), BWGWood.MAHOGANY.sapling().getItem(), BWGWood.MAPLE.sapling().getItem(), BWGWood.SILVER_MAPLE_SAPLING.getItem(), BWGWood.PALM.sapling().getItem(), BWGWood.PINE.sapling().getItem(), BWGWood.REDWOOD.sapling().getItem(), BWGWood.WHITE_MANGROVE.sapling().getItem(), BWGWood.WILLOW.sapling().getItem(),
                    BWGWood.WITCH_HAZEL.sapling().getItem(), BWGWood.ZELKOVA.sapling().getItem(), BWGWood.BROWN_ZELKOVA_SAPLING.getItem(), BWGWood.IRONWOOD.sapling().getItem(), BWGWood.RAINBOW_EUCALYPTUS.sapling().getItem(), BWGWood.ARAUCARIA_SAPLING.getItem(), BWGWood.ORCHARD_SAPLING.getItem(), BWGWood.YUCCA_SAPLING.getItem(), BWGWood.SPIRIT.sapling().getItem()).addTag(BWGItemTags.GLOWCANE_SHOOT).addTag(BWGItemTags.BIRCH_SAPLINGS).addTag(BWGItemTags.SPRUCE_SAPLINGS);
            tag(ModTags.Items.SUMMER_CROPS).add(BWGItems.ODDION_BULB.get(), BWGItems.BLUEBERRIES.get(), BWGWood.BAOBAB.sapling().getItem(), BWGWood.JACARANDA.sapling().getItem(), BWGWood.INDIGO_JACARANDA_SAPLING.getItem(), BWGWood.MAHOGANY.sapling().getItem(), BWGWood.PALM.sapling().getItem(), BWGWood.REDWOOD.sapling().getItem(), BWGWood.WHITE_MANGROVE.sapling().getItem(),
                    BWGWood.PALO_VERDE_SAPLING.getItem(), BWGWood.RAINBOW_EUCALYPTUS.sapling().getItem(), BWGWood.GREEN_ENCHANTED.sapling().getItem(), BWGWood.BLUE_ENCHANTED.sapling().getItem(), BWGWood.ARAUCARIA_SAPLING.getItem(), BWGWood.ORCHARD_SAPLING.getItem(), BWGWood.YUCCA_SAPLING.getItem(), BWGWood.SPIRIT.sapling().getItem()).addTag(BWGItemTags.GLOWCANE_SHOOT);
            tag(ModTags.Items.WINTER_CROPS).add(BWGWood.SKYRIS.sapling().getItem()).addTag(BWGItemTags.SPRUCE_SAPLINGS);
    ...
    private static class EnchantmentTagGenerator extends EnchantmentTagsProvider {
        ...
        private EnchantmentTagGenerator(PackOutput arg, CompletableFuture<HolderLookup.Provider> completableFuture) {
            super(arg, completableFuture, BiomesWeveGone.MOD_ID);
        }
