...
public class MediumPumpkinFeature extends Feature<NoneFeatureConfiguration> {
    private static final ResourceKey<Feature<?>> AUTUMNITY_PUMPKIN_FEATURE = ResourceKey.create(Registries.FEATURE, new ResourceLocation("autumnity", "pumpkin_fields_pumpkin"));
