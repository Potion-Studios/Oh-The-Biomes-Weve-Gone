...
public class BlockFeatures {
    ...
    public static void registerFlammable(TriConsumer<Block, Integer, Integer> consumer) {
        ...
        BWGBlocks.BLOCKS.forEach(entry -> {
            ...
            else if (block instanceof SweetBerryBushBlock || block instanceof FlowerBlock || block instanceof TallFlowerBlock || block instanceof TallGrassBlock || block instanceof FlowerBedBlock || block instanceof FlatVegetationBlock || block instanceof SporeBlossomBlock)
