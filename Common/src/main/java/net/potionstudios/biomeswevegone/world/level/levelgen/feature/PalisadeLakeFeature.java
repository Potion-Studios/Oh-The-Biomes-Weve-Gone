...
public class PalisadeLakeFeature extends Feature<NoneFeatureConfiguration> {

    public static final Direction[] DIRECTIONS = new Direction[]{Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST};


    public PalisadeLakeFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
                ...
                if (noise < noiseWaterThreshold) {
                    ...
                    if (chunk.getBlockState(mutable).canOcclude()) {
                        ...
                        for (Direction direction : DIRECTIONS) {
                            ...
                            if (!level.getBiome(mutable).is(BWGBiomes.PALISADE_GROVE)) {
                                mayPlace = false;
                                break;
                            }
