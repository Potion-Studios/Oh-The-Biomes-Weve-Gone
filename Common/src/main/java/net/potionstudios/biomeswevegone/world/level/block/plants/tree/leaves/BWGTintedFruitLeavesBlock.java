...
public class BWGTintedFruitLeavesBlock extends TintedParticleLeavesBlock implements BonemealableBlock {
	private final Supplier<BWGFruitBlock> fruitBlock;
	private final float tickSpawnChance;

	public BWGTintedFruitLeavesBlock(Properties properties, Supplier<BWGFruitBlock> fruitBlock, float tickSpawnChance) {
