...
public class BWGTintedChangingLeavesBlock extends TintedParticleLeavesBlock implements BonemealableBlock {

	private final Supplier<LeavesBlock> next;
	private final float chance;

	public BWGTintedChangingLeavesBlock(Properties properties, Supplier<LeavesBlock> next, float chance) {
