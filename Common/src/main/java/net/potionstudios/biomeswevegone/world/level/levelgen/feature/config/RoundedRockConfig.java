...
public record RoundedRockConfig(
    ...
    public static final Codec<RoundedRockConfig> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    IntProviders.POSITIVE_CODEC.fieldOf("radius").forGetter(RoundedRockConfig::radius),
                    IntProviders.POSITIVE_CODEC.fieldOf("height").forGetter(RoundedRockConfig::height),
                    FloatProviders.CODEC.fieldOf("noise_frequency").forGetter(RoundedRockConfig::noiseFrequency),
