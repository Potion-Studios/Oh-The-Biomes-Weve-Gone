...
public class BWGRegionUtils {
    ...
    public static ResourceKey<Biome>[][] filter(String configKey, Identifier regionName, int configIDX, ResourceKey<Biome>[][] biomeArray, Predicate<ResourceKey<Biome>> filter, boolean throwsException) {
