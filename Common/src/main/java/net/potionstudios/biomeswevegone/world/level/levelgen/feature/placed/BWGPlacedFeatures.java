...
public class BWGPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> PALISADE_LAKE = PlacedFeaturesUtil.createPlacedFeature("palisade_lake", BWGOverworldConfiguredFeatures.PALISADE_LAKE, List::of);
