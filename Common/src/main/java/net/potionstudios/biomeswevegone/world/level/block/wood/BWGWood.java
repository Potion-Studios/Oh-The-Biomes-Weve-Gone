...
public class BWGWood {
    ...
    public static final PottedBlock TUSCANY_CYPRESS_SAPLING = createNonSetSapling("tuscany_cypress", BWGTreeGrowers.CYPRESS, BlockTags.DIRT);
    ...
    public static final Supplier<LeavesBlock> TUSCANY_CYPRESS_LEAVES = registerLeaves("tuscany_cypress");
    ...
    private static Supplier<LeavesBlock> registerLeaves(String key) {
        return registerNonSetBlockItem(key + "_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES)));
    }

    private static Supplier<LeavesBlock> registerLeaves(String key, Supplier<SimpleParticleType> particleType) {
        return registerNonSetBlockItem(key + "_leaves", () -> new BWGLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES), particleType));
    }

    private static Supplier<LeavesBlock> registerSakuraLeaves(String key, Supplier<SimpleParticleType> particleType) {
        return registerNonSetBlockItem(key + "_leaves", () -> new BWGLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES), particleType));
    }

    private static Supplier<LeavesBlock> registerFloweringLeaves(String key, Supplier<LeavesBlock> ripeLeaves, float chance) {
        return registerNonSetBlockItem(key + "_leaves", () -> new BWGChangingLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES), ripeLeaves, chance));
    }

    private static Supplier<LeavesBlock> registerLeaves(String key, Supplier<BWGFruitBlock> bwgFruitBlockSupplier, float chance) {
        return registerNonSetBlockItem(key + "_leaves", () -> new BWGFruitLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES), bwgFruitBlockSupplier, chance));
    }
