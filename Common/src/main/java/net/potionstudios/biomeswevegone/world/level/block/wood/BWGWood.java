...
public class BWGWood {
    ...
    public static final Supplier<LeavesBlock> ARAUCARIA_LEAVES = registerLeaves("araucaria");
    public static final Supplier<LeavesBlock> RIPE_BAOBAB_LEAVES = registerLeaves("ripe_baobab", BWGBlocks.BAOBAB_FRUIT_BLOCK, 0.04F);
    ...
    public static final Supplier<LeavesBlock> FLOWERING_ORCHARD_LEAVES = registerFloweringLeaves("flowering_orchard", BWGWood.RIPE_ORCHARD_LEAVES, 0.02F);
    ...
    public static final Supplier<LeavesBlock> HOLLY_BERRY_LEAVES = registerLeaves("holly_berry");
    public static final Supplier<LeavesBlock> INDIGO_JACARANDA_LEAVES = registerLeaves("indigo_jacaranda");
    public static final Supplier<LeavesBlock> FLOWERING_JACARANDA_LEAVES = registerLeaves("flowering_jacaranda");
    public static final Supplier<LeavesBlock> FLOWERING_INDIGO_JACARANDA_LEAVES = registerLeaves("flowering_indigo_jacaranda");
    ...
    public static final Supplier<LeavesBlock> SPIRIT_LEAVES = registerNonSetBlockItem("spirit_leaves", properties -> new BWGLeavesBlock(properties, BWGParticles.SPIRIT_LEAVES), BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES));
    public static final Supplier<LeavesBlock> FLOWERING_SPIRIT_LEAVES = registerNonSetBlockItem("flowering_spirit_leaves", properties -> new BWGLeavesBlock(properties, BWGParticles.SPIRIT_LEAVES), BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES).lightLevel(light -> 6));
    public static final Supplier<LeavesBlock> SKYRIS_LEAVES_GREEN_APPLE = registerLeaves("green_apple_skyris", BWGBlocks.GREEN_APPLE_FRUIT_BLOCK, 0.04F);
    public static final Supplier<LeavesBlock> FLOWERING_SKYRIS_LEAVES = registerFloweringLeaves("flowering_skyris", BWGWood.SKYRIS_LEAVES_GREEN_APPLE, 0.02F);
    ...
    private static Supplier<LeavesBlock> registerGlowingLeaves(String key) {
        return registerNonSetBlockItem(key + "_leaves", LeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).lightLevel(state -> 8));
    }

    private static Supplier<LeavesBlock> registerLeaves(String key) {
        return registerNonSetBlockItem(key + "_leaves", LeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
    }

    private static Supplier<LeavesBlock> registerLeaves(String key, Supplier<SimpleParticleType> particleType) {
        return registerNonSetBlockItem(key + "_leaves", properties -> new BWGLeavesBlock(properties, particleType), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
    }

    private static Supplier<LeavesBlock> registerSakuraLeaves(String key, Supplier<SimpleParticleType> particleType) {
        return registerNonSetBlockItem(key + "_leaves", properties -> new BWGLeavesBlock(properties, particleType), BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES));
    }

    private static Supplier<LeavesBlock> registerFloweringLeaves(String key, Supplier<LeavesBlock> ripeLeaves, float chance) {
        return registerNonSetBlockItem(key + "_leaves", properties -> new BWGChangingLeavesBlock(properties, ripeLeaves, chance), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
    }

    private static Supplier<LeavesBlock> registerLeaves(String key, Supplier<BWGFruitBlock> bwgFruitBlockSupplier, float chance) {
        return registerNonSetBlockItem(key + "_leaves", properties -> new BWGFruitLeavesBlock(properties, bwgFruitBlockSupplier, chance), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
    }
