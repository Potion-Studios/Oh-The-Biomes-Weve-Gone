...
public class BWGOverworldVegationPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> IRONWOOD_PLATEAU_PATCH_GRASS_WORLD_SURFACE = PlacedFeaturesUtil.createPlacedFeature("ironwood_plateau_patch_grass_world_surface", VegetationFeatures.GRASS, () -> List.of(CountPlacement.of(20), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, SurfaceRelativeThresholdFilter.of(Heightmap.Types.WORLD_SURFACE_WG, 5, Integer.MAX_VALUE), BiomeFilter.biome()));
    public static final ResourceKey<PlacedFeature> PATCH_GRASS_JUNGLE_WORLD_SURFACE = PlacedFeaturesUtil.createPlacedFeature("patch_grass_jungle_pillar", VegetationFeatures.GRASS_JUNGLE, () -> List.of(CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, SurfaceRelativeThresholdFilter.of(Heightmap.Types.WORLD_SURFACE_WG, 5, Integer.MAX_VALUE), BiomeFilter.biome()));
    ...
    public static final ResourceKey<PlacedFeature> SMALL_PUMPKIN = PlacedFeaturesUtil.createPlacedFeature("small_pumpkin", VegetationFeatures.PUMPKIN, () -> List.of(CountPlacement.of(9), RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
