...
dependencies {
    ...
    compileOnly("io.github.llamalad7:mixinextras-common:0.5.3")?.let { annotationProcessor(it) }
    include("io.github.llamalad7:mixinextras-forge:0.5.3")?.let { implementation(it) }
}
