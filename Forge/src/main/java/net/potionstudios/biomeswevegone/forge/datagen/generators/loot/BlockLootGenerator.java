...
class BlockLootGenerator extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(BWGBlocks.ARAUCARIA_LEAVES.get(), createLeavesDrops(BWGBlocks.ARAUCARIA_LEAVES.get(), BWGWood.ARAUCARIA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.BLUE_SPRUCE_LEAVES.get(), createLeavesDrops(BWGBlocks.BLUE_SPRUCE_LEAVES.get(), BWGWood.BLUE_SPRUCE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.BROWN_BIRCH_LEAVES.get(), createLeavesDrops(BWGBlocks.BROWN_BIRCH_LEAVES.get(), BWGWood.BROWN_BIRCH_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.BROWN_OAK_LEAVES.get(), createLeavesDrops(BWGBlocks.BROWN_OAK_LEAVES.get(), BWGWood.BROWN_OAK_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.BROWN_ZELKOVA_LEAVES.get(), createLeavesDrops(BWGBlocks.BROWN_ZELKOVA_LEAVES.get(), BWGWood.BROWN_ZELKOVA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        add(BWGBlocks.INDIGO_JACARANDA_LEAVES.get(), createLeavesDrops(BWGBlocks.INDIGO_JACARANDA_LEAVES.get(), BWGWood.INDIGO_JACARANDA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.FLOWERING_INDIGO_JACARANDA_LEAVES.get(), createLeavesDrops(BWGBlocks.FLOWERING_INDIGO_JACARANDA_LEAVES.get(), BWGWood.INDIGO_JACARANDA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.ORANGE_BIRCH_LEAVES.get(), createLeavesDrops(BWGBlocks.ORANGE_BIRCH_LEAVES.get(), BWGWood.ORANGE_BIRCH_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.ORANGE_OAK_LEAVES.get(), createLeavesDrops(BWGBlocks.ORANGE_OAK_LEAVES.get(), BWGWood.ORANGE_OAK_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.ORANGE_SPRUCE_LEAVES.get(), createLeavesDrops(BWGBlocks.ORANGE_SPRUCE_LEAVES.get(), BWGWood.ORANGE_SPRUCE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.ORCHARD_LEAVES.get(), createLeavesDrops(BWGBlocks.ORCHARD_LEAVES.get(), BWGWood.ORCHARD_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.FLOWERING_ORCHARD_LEAVES.get(), createLeavesDrops(BWGBlocks.FLOWERING_ORCHARD_LEAVES.get(), BWGWood.ORCHARD_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        add(BWGBlocks.RED_BIRCH_LEAVES.get(), createLeavesDrops(BWGBlocks.RED_BIRCH_LEAVES.get(), BWGWood.RED_BIRCH_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.RED_MAPLE_LEAVES.get(), createLeavesDrops(BWGBlocks.RED_MAPLE_LEAVES.get(), BWGWood.RED_MAPLE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.RED_OAK_LEAVES.get(), createLeavesDrops(BWGBlocks.RED_OAK_LEAVES.get(), BWGWood.RED_OAK_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.RED_SPRUCE_LEAVES.get(), createLeavesDrops(BWGBlocks.RED_SPRUCE_LEAVES.get(), BWGWood.RED_SPRUCE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.SILVER_MAPLE_LEAVES.get(), createLeavesDrops(BWGBlocks.SILVER_MAPLE_LEAVES.get(), BWGWood.SILVER_MAPLE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.YELLOW_BIRCH_LEAVES.get(), createLeavesDrops(BWGBlocks.YELLOW_BIRCH_LEAVES.get(), BWGWood.YELLOW_BIRCH_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.YELLOW_SPRUCE_LEAVES.get(), createLeavesDrops(BWGBlocks.YELLOW_SPRUCE_LEAVES.get(), BWGWood.YELLOW_SPRUCE_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.YUCCA_LEAVES.get(), createLeavesDrops(BWGBlocks.YUCCA_LEAVES.get(), BWGWood.YUCCA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(BWGBlocks.FLOWERING_YUCCA_LEAVES.get(), createLeavesDrops(BWGBlocks.FLOWERING_YUCCA_LEAVES.get(), BWGWood.YUCCA_SAPLING.getBlock(), NORMAL_LEAVES_SAPLING_CHANCES));
